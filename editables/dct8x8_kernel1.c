...
* \brief Contains CUDA implementations of DCT, IDCT and quantization routines,
...
/**
**************************************************************************
*  Performs  implementation of 8x8 block-wise Forward Discrete Cosine Transform of the given
